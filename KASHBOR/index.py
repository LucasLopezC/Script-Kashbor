...
def inferir_tipo_movimiento(texto: str) -> str:
    t = (texto or "").lower()
    if any(w in t for w in ["débito","debito","compra","consumo","pago","retiro","extracción","extraccion","gas", "pago enviado", "gasto enviado", "pago realizado", "gasto realizado", "pago efectuado", "gasto efectuado","enviado"]):
        return "debito"
